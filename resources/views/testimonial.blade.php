<x-app-layout>
    ...
    <div class="py-12 relative" x-data="{ isEdit: false }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg space-y-2">
                <div class=" flex items-center justify-between py-4 px-6">
                    ...
                    <x-primary-button class=" flex items-center justify-center" x-data @click="$store.formTestimonial.toggle()">
        ...
        <div x-data x-show="$store.formTestimonial.show" x-transition>
            <x-form-testimonial :routeStore="route('testimonial.store')" :routeEdit="route('testimonial.edit')"></x-form-testimonial>
        </div>
    </div>
</x-app-layout>
